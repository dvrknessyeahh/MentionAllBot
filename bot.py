...
async def start(event):
  await event.reply(f"__👋🏻 Hallo [{usr.first_name}](tg://user?id={usr.id}) **Saya adalah {bot_name} Bot**, Saya dapat menyebutkan hampir semua anggota di grup atau chanel \nKlik **/help** untuk informasi lebih lanjut__\n\n👨‍💻 Bot ini dikelola oleh {owner_bot}",
                    buttons=(
